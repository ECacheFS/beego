...
var indexTpl = `
{{define "content"}}
<h1>Ge-Cache Admin Dashboard</h1>
<p>
Edge cache service node admin dashboard
</p>
<p>
<a target="_blank" href="https://github.com/yaowenxu">Ge-Cache Author</a>
</p>
{{.Content}}
{{end}}`
...
<li>
<a target="" href="/">Ge-Cache Admin</a>
</li>
