...
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/ECacheFS/beego.GoVersion=${go_version[2]:2}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/ECacheFS/beego.GitBranch=${CURRENT_BRANCH}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/ECacheFS/beego.BuildTime=$BUILD_TIME"
